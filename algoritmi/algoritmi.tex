...
\begin{itemize}
    \item La \textbf{classe P} è la classe dei problemi risolvibili in tempo polinomiale nella dimensione n dell'istanza di ingresso:
    $$ P = \cup^\infty_c_=_0 \hspace{0.1cm} TIME(n^c)$$
    \item La classe PSPACE è la classe dei problemi risolvibili in spazio polinomiale nella dimensione n dell'istanza di ingresso:
