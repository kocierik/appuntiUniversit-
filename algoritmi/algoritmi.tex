...
\begin{center}
    \includegraphics[width=5cm]{images/algoritmoCopertura.png}
\end{center}
\begin{itemize}
    \item Archi blu
    \begin{itemize}
...
\begin{itemize}
    ...
    \item Un arco ${u, v}$ \textbf{attraversa il taglio} se $u \in S e v ∈ V - S$
...
\begin{center}
    \includegraphics[width=5cm]{images/esempioCopertura.png}
\end{center}
...
\begin{center}
    \includegraphics[width=5cm]{images/kruskal.png}
\end{center}
